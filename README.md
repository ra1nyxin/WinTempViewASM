...
- 安全、驱动、远控、代理和设备工具：腾讯柠檬、腾讯电脑管家、360 安全卫士、360 杀毒、火绒、鲁大师、驱动精灵、Driver Booster、联想电脑管家、华为电脑管家、小米助手、华为手机助手、360 压缩、ToDesk、向日葵、RustDesk、Parsec、AnyDesk、TeamViewer、Clash for Windows、Clash Verge、v2rayN、Netch。覆盖日志、缓存、临时目录、下载目录、代理客户端运行日志和崩溃目录。
